...
(() => {
  ...
  const pt = {
    ...
    "feat.3.p": "100% local e offline. Sem nuvem, sem conta, sem API key obrigatória, sem telemetria. O modelo baixa uma vez e roda offline.",
    ...
    "faq.1.a": "Não — por padrão tudo roda local e offline: sem chamadas de rede, sem telemetria, sem conta. A única exceção é um LLM hosted que você escolhe ativar no setup (o Ollama local segue 100% offline).",
    "faq.2.q": "Tem algum custo?",
    "faq.2.a": "Não — $0 por padrão. Embeddings locais, sem API key obrigatória. O `abs setup` oferece uma etapa de LLM guiada e pulável que afia a recall — Ollama local é $0 e offline, ou qualquer endpoint hosted compatível com OpenAI; sua chave nunca é armazenada. Pule e a recall continua funcionando.",
